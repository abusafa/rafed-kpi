...
const INSIGHTS: Record<string, { en: string; ar: string }> = {
  ...
  "risk-escalation": {
    en: "🚨 You have 4 CRITICAL risks — up from 2 last month. Two of these have been open for more than 30 days with no recorded mitigation action. The risk 'Key vendor delivery delay' is linked to 3 KPIs that are all currently in RED status. This is your highest-priority risk cluster and requires executive-level attention.",
  ...
  "initiative-health": {
    en: "📋 15 of 23 initiatives (65%) are on track this quarter. 4 initiatives are flagged AT_RISK due to blocked milestones. The 'Digital Transformation' initiative is the most critical: 6 of 12 milestones are overdue and 3 associated KPIs are declining. Resource reallocation is recommended before the end of Q2.",
  ...
  "employee-contribution": {
    en: "👥 Team contribution compliance this month is 78% — 3 managers have submitted all their KPI values, 2 are 5+ days overdue. Ahmed Al-Rashid leads with 100% on-time submissions across all 8 assigned KPIs. The Operations department has the highest overdue rate (34%) — targeted follow-up is recommended.",
  ...
  "kpi-performance": {
    en: "📈 KPI performance improved overall this quarter: 52% of KPIs are GREEN (up from 41%), 28% AMBER, and 20% RED. The biggest improvement was in the Finance category (+18pp). However, 12 KPIs still have no data entered for the current period — data freshness remains your most critical governance risk.",
