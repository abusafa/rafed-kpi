...
The KPI has shown a consistent downward trend over the past 4 reporting periods. This is not a one-time data entry anomaly — the trajectory indicates a structural issue.

### Contributing Factors Found:

**1. 🔴 Linked Risk — HIGH Severity (Open 32 days)**
A high-severity risk associated with this strategic area has been open for 32 days with no recorded mitigation action. This risk directly affects the operational conditions under which this KPI is measured.

**2. 🟡 Correlated KPI Decline**
Two related KPIs in the same pillar have also declined over the same period, suggesting the root cause is systemic rather than isolated to this one metric.

**3. ⚠️ Project Milestone Delays**
The linked initiative has 2 of its 5 milestones in BLOCKED status. The deliverables from those milestones were expected to drive improvement in this KPI.
...
4. Consider updating the KPI target if external conditions have materially changed since baseline was set`;
